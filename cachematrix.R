## makeCacheMatrix stores and retrieves the inverse for given matrix as well as the matrix itself.
...
## else calculates the inverse of matrix and stores in cache and returns inverse of matrix to display.
